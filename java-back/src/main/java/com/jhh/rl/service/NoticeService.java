...
////    Result addnotice(AddNoticeRequset addNotice);
////
////    Result<List<Notice>> noticelist(GetNoticeListRequset getNoticeList);
////
////    Result delnotice(Integer id);
////
////    Result<List<GetNoticeListResponse>> getnoticelist(Integer id);
//}
