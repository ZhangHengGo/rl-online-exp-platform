...
//        String filePath = "D:\\xianshangpingtai\\rl-online-exp-platform\\vue-front\\src\\assets\\new2.csv"; // 替换为实际文件路径
...
//            List<Double> uncertainty = new ArrayList<>();
//
//            for (CSVRecord record : records) {
//                int episode_i = Integer.parseInt(record.get("episode_i"));
//                if (episode_i == episodeToFind) {
//                    String tq = record.get("targets_Qvalue");
//                    String e = record.get("entropy");
//                    String u = record.get("uncertainty");
//
//                    if ((tq == null || tq.trim().isEmpty()) && (e == null || e.trim().isEmpty())){
//                        break;
//                    }
//                    if(tq != null && !tq.trim().isEmpty()){
//                        double tqD = Double.parseDouble(record.get("targets_Qvalue"));
//                        targetValue.add(tqD);
//                    }
//                    if(e != null && !e.trim().isEmpty()){
//                        double eD = Double.parseDouble(record.get("entropy"));
//                        entropy.add(eD);
//                    }
//                    if(u != null && !u.trim().isEmpty()){
//                        double uD = Double.parseDouble(record.get("uncertainty"));
//                        uncertainty.add(uD);
//                    }
//                }
//            }
